            ...
            <div className="auth-split-content">
                ...
                <div style={{ width: '100%', maxWidth: '360px', margin: '0 auto' }}>
                    <div style={{ marginBottom: '2rem' }}>
                        <h2 style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: '0.5rem' }}>Candidate Register</h2>
                        <p style={{ color: 'var(--text-secondary)', fontSize: '0.875rem' }}>Create an account to start applying for jobs</p>
                    </div>
                    ...
                    <div style={{ marginTop: '1.5rem', textAlign: 'center', fontSize: '0.85rem' }}>
                        ...
                        <Link to="/candidate/login" style={{ fontWeight: 600 }}>Sign In</Link>
                    </div>
                </div>
            </div>
        </div>
